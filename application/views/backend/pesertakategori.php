...
<div class="row-fluid">
	...
	<h3 class="header smaller lighter blue">
		<?php
				if($b==1)
					echo "Semua Data Peserta Seminar / Workshop";
				if($b==2)
					echo "Semua Data Peserta Game";
				if($b==3)
					echo "Semua Data Peserta Projek";
		?>
	</h3>
	<div class="table-header">
		...
		<?php
				if($b==1)
					echo "Data Peserta Seminar / Workshop";
				if($b==2)
					echo "Data Peserta Game";
				if($b==3)
					echo "Data Peserta Projek";
		?>
	</div>
	<?php } ?>
